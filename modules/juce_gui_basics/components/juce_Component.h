...
private:
    ...
    */
    ...
    inline void internalRepaint (Rectangle<int>);
    inline void internalRepaintUnchecked (Rectangle<int>, bool);
    ...
    inline void paintComponentAndChildren (Graphics&);
    inline void paintWithinParentContext (Graphics&);
    inline void sendMovedResizedMessages (bool wasMoved, bool wasResized);
    inline void sendMovedResizedMessagesIfPending();
    void repaintParent();
